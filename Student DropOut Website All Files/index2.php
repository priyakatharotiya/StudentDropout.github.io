...
<body>
    <main>
        ...
        <div class="main-div pad">
            ...
            <form action="/index2" name="myForm" class="box-details" method="post">
                <div class="form flex">
                    ...
                    <div class="formdesign" id="poss_reason">
                        Possible Reason:
                        <select id="select" required name="selectreason">
                            ...
                            <option value="not_apt_for_girls">Not Apt for Girls</option>
                            <option value="other">Other: <input type="text" name="fother_reason" style="display: none;"></option>
                        </select>
                    </div>
                ...
                <button class="but" type="submit" name="submit">Submit</button>
            </form>
        </div>
    </main>
</body>
