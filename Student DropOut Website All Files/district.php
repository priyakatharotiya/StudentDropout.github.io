...
<body>
        ...
        <div class="main-div pad">
            ...
            <div class="admin_details flex">
                <div class="admin-welcome box-details">
                    ...
                    <div class="btn">
                        <button onclick="document.location='index.php'">Add New Entry</button>
                    </div>
                </div>
                    ...
                    <div>
                        <form>
                            ...
                            <select id="Selectdesiredfilter" name="category" style="margin-top: 20px;width:250px">
                                ...
                                <option value="School1">Shiv shakti</option>
                                <option value="School2">Bora talav</option>
                                <option value="School3">Prathmik shala</option>
                                <option value="School4">Vrundavan schools</option>
                            </select>
                            <br>
                        </form>
                    </div>
    ...
    <script>
        // JavaScript code can be placed here for client-side interactions
    ...
    <script>
        // Create a bar chart
        var labels = ['Poverty', 'Child Marriage', 'Lacks Girls Facilities', 'Bad Infrastructure', 'No Teachers', 'Bullying', 'Lack of Interest'];
